...
#define UE_PROJECT_NAME speCPPUnreal
#define UE_TARGET_NAME speCPPUnrealEditor
#define UE_MODULE_NAME "speCPPUnreal"
...
#define SPECPPUNREAL_API DLLEXPORT
